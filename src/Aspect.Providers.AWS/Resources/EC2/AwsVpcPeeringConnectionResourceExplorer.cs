...
{
    internal sealed class AwsVpcPeeringConnectionResourceExplorer : AWSResourceExplorer
    {
        public AwsVpcPeeringConnectionResourceExplorer()
            : base(typeof(AwsVpcPeeringConnection))
        {
        }
